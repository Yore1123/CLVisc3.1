...
int main(int argc, char** argv)
{
    ...
    if (argc == 5 ) {
        ...
        std::cerr << "Usage: ./spec hypersf_directory Tfrz_on decay_on eos_type gpu_id" << std::endl;
        std::cerr << "Example: ./spec /home/name/results/event0 true true LATTICE_PCE165 0" << std::endl;
    }


    clock_t t;
    t = clock();
    Spec spec(pathin,  DECAY_ON, GPU_ID,EOS_TYPE);
